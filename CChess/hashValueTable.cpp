...
int GetPvLine(const int depth, CHESS_BOARD *pos) {
...
int ProbeHashEntry(CHESS_BOARD *pos, int *move, int *score, int alpha, int beta, int depth) {
...
void StoreHashEntry(CHESS_BOARD *pos, const int move, int score, const int flags, const int depth) {
...
int ProbePvMove(const CHESS_BOARD *pos) {
