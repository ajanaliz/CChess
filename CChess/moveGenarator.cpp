...
int MoveExists(CHESS_BOARD *pos, const int move) {
...
static void AddWhitePawnCapMove(const CHESS_BOARD *pos, const int from, const int to, const int cap, MOVELIST *list) {
...
static void AddWhitePawnMove(const CHESS_BOARD *pos, const int from, const int to, MOVELIST *list) {
